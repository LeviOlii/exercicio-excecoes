public abstract class Professor
{
    ...
    public Professor(String n, int m, int c) {
        try {
            ...
            throw new IllegalStateException( "Valores inv�lidos no construtor Professor");
        }
    }
    ...
    public void setNome(String n) {
        ...
        nome = n.trim(); //retira os espa�os em branco do in�cio e fim da palavra
        if (nome.length() == 0) {
            throw new IllegalArgumentException("Argumento n�o deve ser branco em setNome");
        }
    }
